...
This RFC depends on RFC-0006 (History) and, transitively, RFC-0003 (Repository/Ledger). Because RFC-0006 mandates synchronous History materialization (RFC-0006 Section 4.1), Proof MAY read from History directly without staleness concerns, per Section 3 of this document.
...
The derivation chain flows in one direction:
`Ledger (Repository, RFC-0003) -> History (RFC-0006) -> Proof (RFC-0007)`
